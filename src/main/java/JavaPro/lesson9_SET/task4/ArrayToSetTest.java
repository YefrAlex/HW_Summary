package JavaPro.lesson9_SET.task4;
...
public class ArrayToSetTest {
    public static void main(String[] args) {
        Integer[] array = {5, 9, 12, 7, 2, 5};
        System.out.println("Исходный массив -           " + Arrays.toString(array));

        System.out.println("Результат 'наивный метод' - " + getSetFromArray1(array));
        System.out.println("Результат 2 'используем  asList'  - " + getSetFromArray2(array));
        System.out.println("Результат 3 - Collections.addAll " + getSetFromArray3(array));
    ...
    public static Set<Integer> getSetFromArray5(Integer[] array){
        Set<Integer> result = Set.of(array);// требует УЖЕ ОТСУТСТВИЕ ДУБЛИКАТОВ
